package Crystal.Windows 
{
	...
	public class Completed extends Sprite
	{
		/* Таймер --------------------------------------------------*/
		...
		public function Completed(_text:String)
		{
			text = _text;
			this.x = 0; this.y = 0;
		...
		public function Show():void
		{
			...
			message.alpha = 0.8;
			message.addChild(new Label(150, 30, 700, 50, "Times New Roman", 32, 0xFFFFFF, text));
        ...
        private function completeHandler(e:TimerEvent):void
		{
			...
			(Resource.StartGame as Main).NewGame();
		}
